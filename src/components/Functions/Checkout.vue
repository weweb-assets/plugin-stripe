<template>
    ...
    <wwEditorInputRow
        ...
        label="Products"
        bindable
        @update:modelValue="setProducts"
        @add-item="setProducts([...(products || []), {}])"
    >
        <template #default="{ item, setItem }">
            ...
            <wwEditorInputRow
                ...
                bindable
                small
                @update:modelValue="setItem({ ...item, amount: $event })"
            />
            <wwEditorInputRow
                type="query"
...
export default {
    ...
    methods: {
        setCurrency(currency) {
            this.$emit('update:args', { ...this.args, currency });
        },
        setProducts(products) {
            this.$emit('update:args', { ...this.args, products });
        },
